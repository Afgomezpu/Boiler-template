      ...
      return this.each(function () {
        ...
        $(window).on("resize", function () {
          ...
          function renderAfterResize() {
            var newDataCoords = $(that.stepData.enjoyHintElementSelector)
              .get(0)
              .getBoundingClientRect();

            that.stepData.center_x =
              newDataCoords.left + newDataCoords.width / 2;
            that.stepData.center_y =
              newDataCoords.top + newDataCoords.height / 2;
          ...
          doit = setTimeout(function () {
            if (
              ...
              $(document.body).scrollTo(
                that.stepData.enjoyHintElementSelector,
                150,
                { offset: -200, onAfter: renderAfterResize }
              );
        ...
        that.renderLabel = function (data) {
          ...
          var label_bottom =
            label.offset().top - $(document).scrollTop() + label_h;
        ...
        that.setMarkerColor = function (color) {
          ...
          if (isValidColor(color)) {
            return [$("#poliline"), $("#enjoyhint_arrpw_line")].forEach(
              function (element) {
        ...
        that.renderLabelWithShape = function (data) {
          ...
          var label_vertical_space_required =
            window.innerHeight <= 670
              ? label_shift_with_label_height
              : label_shift_with_label_height + 20;
          ...
          var left_position =
            data.center_x - label_width - data_width_size / 2 - 80;
          ...
          var central_ver_position =
            window.innerHeight / 2 - label_vertical_space_required / 2 + 20;
          ...
          y_from =
            data.center_y > label_y + label_height / 2
          ...
          if (
            data.center_y >= label_y &&
            data.center_y <= label_y + label_height
          ) {
          ...
          setTimeout(function () {
            ...
            if (
              summoryButtonWidth + distance > window.innerWidth ||
              distance < 0
            ) {
              distance = 10;
              ver_button_position =
                y_from < y_to ? label_y - 80 : label_y + label_height + 40;
            }
            ...
            var left_skip =
              distance + that.$prev_btn.width() + that.$next_btn.width() + 20;
